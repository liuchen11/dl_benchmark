...
from gan.util.plot_image import plot_cifar10_data
from gan.util.datasets import cifar10
from gan.cifar10.models.cnn import CIFAR10_Generator, CIFAR10_Discriminator
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type = float, default = 1e-2,
        help = 'the value of learning rate, default = 1e-2')
    ...
    netG = CIFAR10_Generator()
    netD = CIFAR10_Discriminator()
    netG.weight_init()
    netD.weight_init()
    ...
    plot_func = lambda output: plot_cifar10_data(true_rows = 2, fake_rows = 8, cols = 10,
